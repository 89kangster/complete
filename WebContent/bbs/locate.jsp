...
// 	document.getElementById('a1').innerHTML='<a href="http://14.63.225.213/testing/bbs/list.inc" target="_blank" style="text-decoration: none; color: #5d5d5d; font-weight: bold;">'+vv1+'...'+'</a>';

	document.getElementById('a1').innerHTML='<a href="http://14.63.225.213/mainroot/bbsOnSpring.jsp" target="_parent" style="text-decoration: none; color: #5d5d5d; font-weight: bold;">'+vv1+'...'+'</a>';
	document.getElementById('a2').innerHTML='<a href="http://14.63.225.213/mainroot/bbsOnSpring.jsp" target="_parent" style="text-decoration: none; color: #5d5d5d; font-weight: bold;">'+vv2+'...'+'</a>';
	document.getElementById('a3').innerHTML='<a href="http://14.63.225.213/mainroot/bbsOnSpring.jsp" target="_parent" style="text-decoration: none; color: #5d5d5d; font-weight: bold;">'+vv3+'...'+'</a>';
	document.getElementById('a4').innerHTML='<a href="http://14.63.225.213/mainroot/bbsOnSpring.jsp" target="_parent" style="text-decoration: none; color: #5d5d5d; font-weight: bold;">'+vv4+'...'+'</a>';
	document.getElementById('a5').innerHTML='<a href="http://14.63.225.213/mainroot/bbsOnSpring.jsp" target="_parent" style="text-decoration: none; color: #5d5d5d; font-weight: bold;">'+vv5+'...'+'</a>';
